            ...
            <Container className="d-flex justify-content-center">
                <Col lg="8">
                    <Text style={{textAlign: "left"}} className="in-dark">
                        ...
                        film emphasis.  I've constnatly and consistently left my mark at Hendrix.  I've founded and lead student organizations, participated in each tradition, and kept up my studies.  Now, I eagerly await graduation while honing my skills in and out of web design.
                    </Text>
                </Col>
            </Container>
        </div>
